...
import (
	"flag"
	"fmt"
	"github.com/gmarchetti/elasticsearch-indexer-testing-v1/elasticsearch_indexer/elasticsearch_testsuite"
...
func main() {
	...
	testSuite := elasticsearch_testsuite.NewExampleTestsuite(*serviceImageArg)
